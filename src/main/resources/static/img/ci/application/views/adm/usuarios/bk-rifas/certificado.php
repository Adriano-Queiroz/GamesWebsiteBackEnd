        ...
        *====================================-->
        ...
        <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card_title">Certificado</h4>
                            <!--<p class="text-muted font-14 mb-4">Here are examples of <code>.form-control</code> applied to each textual HTML5 <code>&lt;input&gt;</code> <code>type</code>.</p>-->

                            <form action="<?=base_url()?>adm/usuarios/set_certificado" method="post" >      
                            
                            
                            <div class="col-lg-12 mt-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card_title">Editor certificado</h4>
                                        <textarea class="summer_note_editor" name="certificado" id="certificado" placeholder="Escreve o Certificado" rows="15" cols="80" style="background-color: #fff;border:white 1px solid;padding:1em"><?=$usuario->certificado?></textarea>
