...
<h2 class="small-title">Como Depositar</h2>
<div class="card sh-45 bg-transparent theme-filter-player">
<video class="player cover" poster="<?=base_url()?>img/video/video-depositar.png">
<source src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-576p.mp4" type="video/mp4">
</video>
</div>
</div>
<div class="col-12 col-lg-8 mb-5">
<h2 class="small-title">Como Sacar</h2>
<div class="card sh-45 bg-transparent theme-filter-player">
<video class="player cover" poster="<?=base_url()?>img/video/video-sacar.png">
<source src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-576p.mp4" type="video/mp4">
</video>
</div>
</div>
...
<img src="<?=base_url()?>img/video/faq-videos.png" alt="alternate text" class="card-img card-img-horizontal sw-11 sw-md-14 theme-filter">
<div class="position-absolute bg-foreground opacity-75 text-primary px-1 py-1 text-extra-small b-2 s-2 rounded-lg">Acesse Agora!</div>
</div>
<div class="col">
<div class="card-body d-flex flex-column pt-0 pb-0 h-100 justify-content-center">
<div class="d-flex flex-column">
<div class="font-heading">Acesse agora perguntas frequentes</div>
<div class="text-small text-muted text-truncate">Tire todas suas dúvidas em nossa página de perguntas frequentes, se mesmo assim ainda estiver com dúvidas chame no nosso suporte via whatsapp</div>
</div>
</div>
</div>
</a>
