        ...
        *====================================-->
        ...
        <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card_title">Novo comunicado</h4>
                            <!--<p class="text-muted font-14 mb-4">Here are examples of <code>.form-control</code> applied to each textual HTML5 <code>&lt;input&gt;</code> <code>type</code>.</p>-->

                            <form action="<?=base_url()?>adm/usuarios/set_comunicado" method="post" >                                
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="" id="" placeholder="Título" name="titulo">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 mt-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="" id="" placeholder="Descrição..." name="descricao">
                                        </div>
                                    </div>
                            ...
                            <div class="single-table">
                                <div class="table-responsive">
                                    <table class="table table-hover progress-table text-center">
                                        ...
                                        <tbody>
                                            <? if($comunicados->num_rows() > 0){ ?>
                                                <? foreach($comunicados->result() as $comunicado){ ?>
                                                        ...
                                                        <td><?=$comunicado->descricao?></td>
                                                         <td>
                                                            <ul class="d-flex justify-content-center">
                                                                <li class="mr-3"><a href="<?=base_url()?>adm/usuarios/rem_comunicado/<?=$comunicado->id?>" class="btn btn-secondary" ><i class="fa fa-trash"></i></a></li>
                                                            </ul>
                                                        </td>
