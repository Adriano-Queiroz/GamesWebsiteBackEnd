...
<title>Raspei Ganhei | Redes sociais</title>
...
<div class="row row-cols-1 row-cols-xl-2 g-2">
	...
	<div class="col">
		...
		<i data-acorn-icon="check" data-acorn-size="25"></i>
		</span>
		<div class="card-body">
		<div class="row g-0">
		<div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
		<img src="<?=base_url()?>img/illustration/instagram.png" class="theme-filter" alt="email icon">
		</div>
		<div class="col-12 col-sm">
		<a href="#" class="heading mb-2 d-inline-block">Link Instagram</a>
		<p>
		<span class="text-small text-muted">Rede Social Instagram</span>
		<br>
		<div class="mb-3 filled">
		<i data-acorn-icon="clock"></i>
		<input class="form-control" placeholder="https://instagram.com/raspeiganhei" name="link_instagram" value="<?=$rasp->link_instagram?>">
		</div>
		</p>
		<!--<p>
	...
	<div class="col">
		...
		<div class="row g-0">
		<div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
		<img src="<?=base_url()?>img/illustration/whatsapp.png" class="theme-filter" alt="email icon">
		</div>
		<div class="col-12 col-sm">
		<a href="#" class="heading mb-2 d-inline-block">Link Whatsapp</a>
		<p>
		<span class="text-small text-muted">Link suporte Whatsapp</span>
		<br>
		<div class="mb-3 filled">
		<i data-acorn-icon="clock"></i>
		<input class="form-control" placeholder="https://chat.whatsapp.com/KWFniuwKLwP6O8mWyC0RO5" name="link_whatsapp" value="<?=$rasp->link_whatsapp?>">
		</div>
		</p>
		<!--<p>
		<span class="text-small text-muted">TOKEN MERCADOPAGO</span>
	...
	<div class="col">
		...
		<div class="row g-0">
		<div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
		<img src="<?=base_url()?>img/illustration/telegram.png" class="theme-filter" alt="email icon">
		</div>
		<div class="col-12 col-sm">
		
			<a href="#" class="heading mb-2 d-inline-block">Link Telegram</a>
			<p>
			<span class="text-small text-muted">Suporte Telegram</span>
			<br>
			<div class="mb-3 filled">
			<i data-acorn-icon="clock"></i>
			<input class="form-control" placeholder="https://web.telegram.org/" name="link_telegram" value="<?=$rasp->link_telegram?>">
			</div>
			</p>
			<!--<p>
			<span class="text-small text-muted">TOKEN MERCADOPAGO</span>
